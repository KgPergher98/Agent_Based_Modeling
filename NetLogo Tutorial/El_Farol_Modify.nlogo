...
turtles-own [
  ...
  reward          ;; keep track of when agents go to bar and its not crowded
]
...
to setup
  ...
  create-turtles 100 [
    ...
    set reward 0 ;; reset the reward to the starting condition
    update-strategies
  ]
...
to go
  ...
  ask turtles [
    ...
    ;; scale the color on the basis of reward
